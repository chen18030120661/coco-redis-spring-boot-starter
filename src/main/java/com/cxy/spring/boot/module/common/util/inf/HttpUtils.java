...
public class HttpUtils {
	 ...
	 * @return
	 */
	public static String doGetHttp(String url, Map<String, String> headers, Map<String, String> params) {
	...
	/**
	 * 发送 GET 请求（HTTP），不带输入数据  返回的数据经过gzip压缩
	 *
	 * @param url
	 * @param headers
	 *            需要添加的httpheader参数
	 * @return
	 */
	public static String doGetInGzip(String url, Map<String, String> headers, Map<String, Object> params) {
		...
		try {
			...
			if (entity != null) {
				InputStream instream = entity.getContent();
				httpStr= GzipUtil.uncompress(instream);
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	 ...
	 * @return
	 */
	public static String doPostHttp(String apiUrl, Map<String, String> headers, Map<String, String> params) {
